...
#define TWEAK_TITLE "Teams Plus"
#define TINT_COLOR "#4b9bfe"
#define BUNDLE_NAME "TSPPref"
...
-(void)apply {
  [HCommon killProcess:@"TeamSpaceApp" viewController:self alertTitle:@TWEAK_TITLE message:[self localizedItem:@"DO_YOU_REALLY_WANT_TO_KILL_TEAMS"] confirmActionLabel:[self localizedItem:@"CONFIRM"] cancelActionLabel:[self localizedItem:@"CANCEL"]];
}
